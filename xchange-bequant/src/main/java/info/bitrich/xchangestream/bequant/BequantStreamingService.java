...
import info.bitrich.xchangestream.bequant.dto.BequantWebSocketBaseParams;
import info.bitrich.xchangestream.bequant.dto.BequantWebSocketSubscriptionMessage;
 ...
 */
public class BequantStreamingService extends JsonNettyStreamingService {
    private static final Logger LOG = LoggerFactory.getLogger(BequantStreamingService.class);
    ...
    /**
     * Map request Id to Chanel Name and Bequant method pair
     */
    private final Map<Integer, Pair <String, String>> requests = new HashMap<>();


    public BequantStreamingService(String apiUrl) {
        ...
        if (message.has(JSON_ID)) {
            ...
            if (requests.containsKey(requestId)) {
                ...
                if (message.has(JSON_ERROR)) {
                    ...
                    LOG.info("Bequant returned {} as result of '{}' method", result, subscriptionMethod);
                }
    ...
    public String getSubscribeMessage(String channelName, Object... args) throws IOException {
        BequantWebSocketSubscriptionMessage subscribeMessage = generateSubscribeMessage(channelName, "subscribe");
    ...
    public String getUnsubscribeMessage(String channelName) throws IOException {
        ...
        BequantWebSocketSubscriptionMessage subscribeMessage = generateSubscribeMessage(channelName, "unsubscribe");
        requests.put(subscribeMessage.getId(), ImmutablePair.of(channelName, subscribeMessage.getMethod()));
    ...
    private BequantWebSocketSubscriptionMessage generateSubscribeMessage(String channelName, String methodType) throws IOException {
        ...
        return new BequantWebSocketSubscriptionMessage(requestId, method, new BequantWebSocketBaseParams(symbol));
    }
}
