...
public class BequantStreamingMarketDataServiceTest {

    @Mock
    private BequantStreamingService streamingService;
    private BequantStreamingMarketDataService marketDataService;

    private final ObjectMapper objectMapper = new ObjectMapper();

    @Before
    public void setUp() {
        marketDataService = new BequantStreamingMarketDataService(streamingService);
    }
