...
public class BequantMessageTest {
    private static final Logger LOG = LoggerFactory.getLogger(BequantMessageTest.class);
    ...
    public BequantMessageTest(Class clazz, Matcher<String> matcher, String testResource) {
        this.clazz = clazz;
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {
                        BequantWebSocketSubscriptionMessage.class,
                        allOf(
                ...
                {
                        BequantWebSocketTickerTransaction.class,
                        allOf(
                ...
                {
                        BequantWebSocketTradesTransaction.class,
                        allOf(
                ...
                {
                        BequantWebSocketOrderBookTransaction.class,
                        allOf(
