 ...
 */
public class BequantManualExample {
    private static final Logger LOG = LoggerFactory.getLogger(BequantManualExample.class);

    public static void main(String[] args) {
        StreamingExchange exchange = StreamingExchangeFactory.INSTANCE.createExchange(BequantStreamingExchange.class
                .getName());
