...
public class DsxMessageTest {
    private static final Logger LOG = LoggerFactory.getLogger(DsxMessageTest.class);
    ...
    public DsxMessageTest(Class clazz, Matcher<String> matcher, String testResource) {
        this.clazz = clazz;
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {
                        DsxWebSocketSubscriptionMessage.class,
                        allOf(
                ...
                {
                        DsxWebSocketTickerTransaction.class,
                        allOf(
                ...
                {
                        DsxWebSocketTradesTransaction.class,
                        allOf(
                ...
                {
                        DsxWebSocketOrderBookTransaction.class,
                        allOf(
