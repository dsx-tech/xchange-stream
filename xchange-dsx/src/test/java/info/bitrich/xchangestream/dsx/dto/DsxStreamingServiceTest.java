...
import info.bitrich.xchangestream.dsx.DsxStreamingService;
 ...
 */
public class DsxStreamingServiceTest {

    private final ObjectMapper objectMapper = new ObjectMapper();
    private final DsxStreamingService streamingService = new DsxStreamingService("testUrl");
    ...
    public void getChannelNameFromMessageTest() throws IOException, InvocationTargetException, IllegalAccessException {
        ...
        Method method = MethodUtils.getMatchingMethod(DsxStreamingService.class, "getChannelNameFromMessage", JsonNode.class);
